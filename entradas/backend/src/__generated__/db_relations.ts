...
import { notasFiscais, itensNf } from "./db_schema";

export const itensNfRelations = relations(itensNf, ({one}) => ({
...
export const notasFiscaisRelations = relations(notasFiscais, ({many}) => ({
